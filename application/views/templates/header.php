...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/adminLte/plugins/fileinput/fileinput.min.css') ?>">
  ...
  <script src="<?php echo base_url('assets/adminLte/plugins/fileinput/fileinput.min.js') ?>"></script>
