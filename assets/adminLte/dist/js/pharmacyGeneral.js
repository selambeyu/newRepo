    ...
    function getMsg() {
        if (typeof (EventSource) !== 'undefined') {
            ...
            serverUpdate.onmessage = function (event) {
                ...
                $('#totalAssHeader').html("You have " + totalAssCount + " Medication Orders");
                $('#ass-menu-id').html('');
                for (var i in data[0]) {
                    ...
                    $('#ass-menu-id').append('<li><a href="orderedPharmacyMedications.php">' + data[0][i].fname + ' ' + data[0][i].mname +' '+data[0][i].lname+'</div>');
                }
